*********************************************************
* README.TXT - SourceMonitor - BETA VERSION <=====
*********************************************************

SourceMonitor - Freeware Version 3.5.14.44 - April 24, 2020

C# parser updated for new V8 switch statement syntax.
Java parser updated for new V14 switch and tripple quote syntax.
Export to XML and CSV is now faster.
Fix for all reported bugs through number 273. Details at:
...
All bugs through number 273 have been fixed.
